...
fs.readFile('data/outgoing_links.json', 'utf8', function (err, biketripsdata) {
    ...
    fsstations.readFile('data/stations.json', 'utf8',function(err, stationsdata){
        ...
        fswirting.writeFile('data/biketrips_outgoing.json', JSON.stringify(ingoingdata_byday, null, 4), function(err) {
            if(err) {
                console.log(err);
            } else {
